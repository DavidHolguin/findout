            ...
            >
              <div>
                <div className="relative h-[58px] rounded-2xl overflow-hidden border-2 border-primary">
                  <div className="flex h-[58px] items-center justify-between p-4 bg-gradient-to-t from-primary/50 to-transparent via-transparent dark:bg-gradient-to-l dark:from-primary/80 dark:via-primary/20 dark:to-transparent">
