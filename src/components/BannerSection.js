...
const BannerSection = () => {
  return (
    <section className="w-full h-[150px] mb-20 flex justify-center items-center gap-2.5 bg-cover bg-center" style={{backgroundImage: "url('https://findout.store/wp-content/uploads/2024/05/registrateAhora.png')"}}>
