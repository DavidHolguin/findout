...
const ChromeShareIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="none" viewBox="0 0 42 42">
  <path fill="#E1E1E2" d="M0 9.75A3.75 3.75 0 0 1 3.75 6H20c8.284 0 15 6.716 15 15 0 8.284-6.716 15-15 15H3.75A3.75 3.75 0 0 1 0 32.25V9.75Z"/>
  <path stroke="#636366" stroke-opacity=".6" d="M3.75 6.5H20c8.008 0 14.5 6.492 14.5 14.5S28.008 35.5 20 35.5H3.75A3.25 3.25 0 0 1 .5 32.25V9.75A3.25 3.25 0 0 1 3.75 6.5Z"/>
  <rect width="40" height="40" x="1" y="1" stroke="#09FDFD" stroke-width="2" rx="8"/>
  <path fill="#5D5D5E" d="M16.996 23.755c.34 0 .631-.287.631-.622v-8.19l-.047-1.196.528.566 1.199 1.292a.56.56 0 0 0 .426.191.559.559 0 0 0 .386-.98l-2.666-2.6c-.157-.16-.291-.216-.457-.216-.158 0-.292.056-.457.215l-2.666 2.6a.56.56 0 0 0-.182.415c0 .327.237.566.568.566a.59.59 0 0 0 .434-.191l1.19-1.292.537-.566-.047 1.196v8.19c0 .335.284.622.623.622ZM12.476 30h9.047C23.172 30 24 29.17 24 27.528v-7.96c0-1.642-.828-2.472-2.477-2.472h-2.2v1.284H21.5c.78 0 1.23.43 1.23 1.26v7.816c0 .83-.45 1.26-1.23 1.26h-9.008c-.788 0-1.222-.43-1.222-1.26V19.64c0-.83.434-1.26 1.222-1.26h2.185v-1.284h-2.2c-1.649 0-2.477.83-2.477 2.473v7.959C10 29.17 10.828 30 12.477 30Z"/>
</svg>
