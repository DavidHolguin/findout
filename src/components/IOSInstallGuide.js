...
const ChromeShareIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="none" viewBox="0 0 42 42">
  <path fill="#E1E1E2" d="M1 7.071A4.071 4.071 0 0 1 5.071 3H21c9.941 0 18 8.059 18 18s-8.059 18-18 18H5.071A4.071 4.071 0 0 1 1 34.929V7.07Z"/>
  <path stroke="#636366" stroke-opacity=".6" d="M5.071 3.5H21c9.665 0 17.5 7.835 17.5 17.5S30.665 38.5 21 38.5H5.071A3.571 3.571 0 0 1 1.5 34.929V7.07A3.571 3.571 0 0 1 5.071 3.5Z"/>
  <rect width="40" height="40" x="1" y="1" stroke="#09FDFD" stroke-width="2" rx="8"/>
  <path fill="#5D5D5E" d="M15.994 24.327c.485 0 .902-.399.902-.864V12.087l-.068-1.661.755.786 1.713 1.795a.81.81 0 0 0 .608.266c.462 0 .823-.333.823-.787 0-.233-.102-.41-.27-.576l-3.81-3.61c-.224-.222-.416-.3-.653-.3-.225 0-.416.078-.653.3l-3.809 3.61c-.169.166-.259.343-.259.576 0 .454.338.787.812.787a.853.853 0 0 0 .62-.266l1.7-1.795.767-.786-.068 1.661v11.376c0 .465.406.864.89.864ZM9.538 33h12.924C24.817 33 26 31.848 26 29.566V18.512c0-2.282-1.183-3.434-3.538-3.434h-3.144v1.783h3.11c1.116 0 1.758.598 1.758 1.75v10.855c0 1.152-.642 1.75-1.758 1.75H9.561c-1.127 0-1.747-.598-1.747-1.75V18.611c0-1.152.62-1.75 1.747-1.75h3.12v-1.783H9.539C7.183 15.078 6 16.23 6 18.512v11.054C6 31.848 7.183 33 9.538 33Z"/>
</svg>
