    ...
    >
      ...
      >
        <div className="relative">
          <button
            onClick={onClose}
            className="absolute top-4 left-4 p-2 bg-white rounded-full shadow-md text-gray-500 hover:text-gray-700 transition-transform duration-300 hover:translate-y-1"
          >
            <ChevronDown size={24} />
          </button>
          <img 
